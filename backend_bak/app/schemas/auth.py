...
class ResUserBase(BaseModel):
    ...
    code: str = Field(..., example="TT99999")
    employment_type: str = Field(..., example="社員")
...
class ReqUserCreate(BaseModel):
    ...
    code: str = Field(min_length=1, example="TT99999")
    employment_type: str = Field(min_length=1, example="社員")
...
class ReqUserSearch(ReqBasePagination):
    ...
    code: Optional[str] = Field(None, example="TT99999")
